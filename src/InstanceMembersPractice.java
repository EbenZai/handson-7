...
public class InstanceMembersPractice {
    public static void main(String[] args) {
        ...
        BankAccount account1 = new BankAccount("001", "Eben", 5000000, "Savings");
        BankAccount account2 = new BankAccount("002", "Josef", 6000000, "Current");
        BankAccount account3 = new BankAccount("003", "King", 7000000, "Savings");
