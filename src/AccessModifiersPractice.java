public class AccessModifiersPractice {
    public static void main(String[] args) {
        ...
        BadExample bad = new BadExample("Budi", 25, 5000000, "budi@email.com");
        ...
        GoodExample good = new GoodExample("Siti", 30, 7000000, "siti@email.com");
        System.out.println("Data awal:");
        ...
        good.setEmail("siti.new@email.com");
        System.out.println("Age: " + good.getAge());
        System.out.println("Salary: " + good.getSalary());
        System.out.println("Email: " + good.getEmail());
