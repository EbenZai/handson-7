public class IntroToOOPPractice {
    public static void main(String[] args) {
        ...
        String namaMhs1 = "Eben"; // Isi dengan data mahasiswa 1
        String nimMhs1 = "2481014";
        String jurusanMhs1 = "Teknik Informatika";
        double ipkMhs1 = 3.6;

        String namaMhs2 = "Josef"; // Isi dengan data mahasiswa 2
        String nimMhs2 = "2481041";
        String jurusanMhs2 = "Teknik Informatika";
        double ipkMhs2 = 3.9;

        String namaMhs3 = "billy"; // Isi dengan data mahasiswa 3
        String nimMhs3 = "2481011";
        ...
        Mahasiswa mhs1 = new Mahasiswa("Eben", "2481014","Teknik Informatika",3.6);
        Mahasiswa mhs2 = new Mahasiswa("Josef", "2481041", "Teknik Informatika", 3.9);
        Mahasiswa mhs3 = new Mahasiswa("Billy", "2481011", "Teknik Informatika", 3.7);
        ...
        Buku buku1 = new Buku("10 Dosa Besar Soeharto", "Josef", "098765432",1970, true );
        Buku buku2 = new Buku("Basis Data", "Alan Tuirng", "123456789",2021, true);
        Buku buku3 = new Buku("Pelangi", "saroha", "234567890", 2025, true);
        Mahasiswa peminjam = new Mahasiswa("Eben", "2481014","Teknik Informatika",3.6);
        Perpustakaan perpustakaan = new Perpustakaan("Perpustakaan Kampus", "Jl. Pendidikan No. 1");
