...
public class LibraryManagementSystem {
    public static void main(String[] args) {
        ...
        perpustakaan.registerMember(new Member("M001", "Budi Santoso", "budi@email.com", "08123456789", "Jl. Merdeka 1", MembershipType.STUDENT));
        perpustakaan.registerMember(new Member("M002", "Siti Nurhaliza", "siti@email.com", "08198765432", "Jl. Sudirman 5", MembershipType.FACULTY));
        perpustakaan.registerMember(new Member("M003", "Ahmad Yani", "ahmad@email.com", "08111222333", "Jl. Asia Afrika 10", MembershipType.PUBLIC));
