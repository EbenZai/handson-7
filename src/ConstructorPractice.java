...
public class ConstructorPractice {
    public static void main(String[] args) {
        ...
        Employee e1 = new Employee("E001", "Josef", "Eben", "IT" ,"Developer" ,8000000, LocalDate.of(2020, 5, 15) );
        Employee e2 = new Employee("E002", "Siti", "Rahayu", "HR");
        Employee e3 = new Employee("E003", "Ahmad", "Fauzi");
